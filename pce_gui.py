...
com_label = ttk.Label(root, text="COM port:")
...
text_var = com_var
com_combobox = ttk.Combobox(root,textvariable = com_var, values = comlist)
...
dis_pv1 = ttk.Label(root,text =gpv1.get(),font = LFont)
